...
변경이 만들거나 재편하는 구조 요구—흐름, 생명주기, 부작용·완료 소유권, 조합, 경계 계약—와 추적·검증을 막는 기존 마찰을 확인한다. 집중 검증으로 작업을 현재 단위에 둔다. 다른 단위가 판단, 쓰기, 부작용, 완료 규칙을 소유한다는 증거가 나오면 가장 작은 관련 단위만 다시 연다.
